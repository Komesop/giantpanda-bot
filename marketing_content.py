MARKETING_DB = {
    ...
    "personas": {
        "judith": {
            ...
            "false_beliefs": [
                "Meer omzet betekent harder werken",
                "AI voelt onpersoonlijk",
                "Mijn klanten willen menselijk contact",
            ],
        ...
        "rick": {
            ...
            "technisch": "gemiddeld",
            "pijnpunten": [
                "Kwaliteitsverlies door externen",
                "Communicatieruis",
                "Facturatie loopt achter",
                "Doet zelf alle verkoop",
            ],
            "verlangens": [
                "Systeem dat voor hem werkt",
                "Betrouwbaar team",
                "Kwaliteit borgen",
                "Rust in de kop",
            ],
            "false_beliefs": [
                "Anderen doen het nooit zo goed als ik",
                "Automatisering is te rigide",
                "Kost te veel tijd om in te richten",
            ],
        ...
        "alex": {
            ...
            "pijnpunten": [
                "Silo-vorming",
                "Hoge overhead",
                "Marketing & Sales praten niet",
                "Churn door trage opvolging",
            ],
            "verlangens": [
                "Voorspelbare groei",
            ...
            "false_beliefs": [
                "Onze processen zijn te complex",
                "We hebben al veel tools",
                "Veranderweerstand",
            ],
        ...
        "victor": {
            ...
            "pijnpunten": [
                ...
                "Afhankelijkheid van key-employees",
                "Innovatie-schuld",
            ],
            "verlangens": [
                "Passief inkomen",
                "Overdraagbaar bedrijf",
                "Impact maken",
            ],
            "false_beliefs": [
                "Te groot om te veranderen",
                "Automatisering is voor kleine bedrijven",
                "Mijn personeel doet het al jaren zo",
            ],
            ...
            "social_proof": [
                {
                    ...
                    "quote": "Tijdens behandelingen miste ik de helft van mijn leads. Nu boekt de assistent 80% van de afspraken.",
                    "metric": "+45% afspraken",
                },
                {
                    "naam": "Marco B.",
                    "branche": "Schildersbedrijf Marco",
                    "quote": "Ik zat tot 22:00 leads op te volgen. Nu plan ik 12 afspraken p/w zonder zelf een WhatsApp te sturen.",
                    "metric": "12 afspraken p/w",
                },
                {
                    "naam": "Jeroen D.",
                    "branche": "Personal Training",
                    "quote": "Sinds de assistent direct reageert, mis ik geen enkele lead meer.",
                    "metric": "3x hogere conversie",
                },
            ],
            "faq": [
                {
                    "vraag": "Mijn bedrijf is te klein voor dit soort tools.",
                    "antwoord": "Daarvoor is het juist gemaakt. Binnen 2 minuten live, geen technische kennis nodig.",
                },
                {
                    "vraag": "Is het nog steeds persoonlijk genoeg?",
                    "antwoord": "De agent spreekt precies dezelfde taal als jij. Jij stelt de toon, hij volgt die exact op.",
                },
                {
                    "vraag": "Heb ik tijd om het in te richten?",
                    "antwoord": "Nee. Dat doen wij voor je. Jij geeft alleen je voorkeuren door en binnen 48 uur is het live.",
                },
                {
                    "vraag": "Wat als ik geen WhatsApp Business API heb?",
                    "antwoord": "Geen probleem. Je werkt eerst met een QR-code, geen API vereist.",
                },
            ],
        },
        "rick": {
            ...
            "whatsapp_voorbeeld": {
                ...
                "ai_2": "Top! Heb je een voorkeur voor datum en wat is je adres? Ik geef dat direct door aan onze monteur.",
            },
            "faq": [
                {
                    "vraag": "Werkt dit ook met mijn losse tools?",
                    "antwoord": "Ja. 40+ integraties, waaronder WhatsApp, Excel, gedeelde agenda's en facturatiesoftware.",
                },
                {
                    "vraag": "Kost het veel tijd om in te richten?",
                    "antwoord": "Nee. Binnen 2 minuten live via QR-code. Daarna doen wij de rest.",
                },
                {
                    "vraag": "Is mijn bedrijf niet te flexibel voor een vaste AI?",
                    "antwoord": "De assistent leert jouw regels. Niet andersom.",
                },
            ],
        },
        "alex": {
            ...
            "punten": [
                {
                    "kop": "CAPACITEIT",
                    "tekst": "Marketing levert meer leads dan sales kan aan. Handmatige opvolging betekent dat 40% van je warme leads afkoelt voordat iemand reageert.",
                },
                {
                    "kop": "PAYROLL",
                    "tekst": "Iedere nieuwe groeifase dwingt je tot extra hires. Je overhead stijgt lineair, je omzet niet.",
                },
                {
                    "kop": "DATA",
                    "tekst": "CRM half gevuld. Slack, formulieren, WhatsApp — iedereen vertelt een ander verhaal.",
                },
                {
                    "kop": "SNELHEID",
                    "tekst": "Je bent te traag. De concurrent die binnen 5 minuten reageert, krijgt de deal.",
                },
            ],
            "unit_economics": {
                "zonder": [
            ...
            "social_proof": [
                {
                    "naam": "Wrapkampioen",
                    "quote": "We besparen momenteel 2 fulltime medewerkers. Onze winst is met 20% gestegen.",
                    "metrics": "-2 FTE | +20% winst",
                },
                {
                    "naam": "Uw Keuken Wrappen",
                    "quote": "Onze tijd per offerte is verlaagd van 15 naar 2 minuten.",
                    "metrics": "-13 min per offerte",
                },
                {
                    "naam": "Agency & Partners",
                    "quote": "Ontvang 15% kickback op elke doorverwezen klant.",
                    "metrics": "15% recurring kickback",
                },
            ],
            "faq": [
                {
                    "vraag": "Onze processen zijn te complex voor een out-of-the-box oplossing.",
                    "antwoord": "De assistent leert jouw exacte workflow. Van intakevragen tot CRM-velden — alles past bij jouw proces.",
                },
                {
                    "vraag": "We hebben al 7 tools. Waar zouden we nog een tool bij moeten nemen?",
                    "antwoord": "Giantpanda vervangt niets. Het voegt een laag van conversie-automatisering toe op je bestaande stack.",
                },
                {
                    "vraag": "Veranderweerstand bij mijn team?",
                    "antwoord": "De assistent neemt het repetitieve werk over: opvolgen, boekingen, data-entry. Je team kan zich richten op wat echt waarde toevoegt.",
                },
            ],
        },
        "victor": {
            ...
            "oplossingspunten": [
                {
                    "titel": "Processen draaien zelfstandig",
                    "tekst": "Dagelijkse taken worden autonoom afgehandeld, fouten met 80% terug.",
                },
                {
                    "titel": "Realtime inzicht",
                    "tekst": "Live dashboards in plaats van wachtende rapportages.",
                },
                {
                    "titel": "Schalen zonder payroll",
                    "tekst": "Verhoog volume met 40% zonder extra backoffice.",
                },
                {
                    "titel": "Hogere winstgevendheid",
                    "tekst": "Operationele hefboomwerking stijgt, marges verbeteren.",
                },
                {
                    "titel": "Exit-proof",
                    "tekst": "Een onafhankelijk draaiend bedrijf is 2-3x meer waard bij verkoop.",
                },
            ],
            "metrics": [
            ...
            "faq": [
                {
                    "vraag": "Is onze procesvoering niet te specifiek?",
                    "antwoord": "Onze assistenten trainen we op jouw exacte bedrijfsregels, protocollen en uitzonderingen.",
                },
                {
                    "vraag": "Veroorzaakt dit downtime?",
                    "antwoord": "Nul downtime. Implementatie gebeurt parallel aan je huidige processen.",
                },
                {
                    "vraag": "Zit er vertrouwen in een AI bij onze klanten?",
                    "antwoord": "De AI communiceert in jouw merk- en toon. Klanten merken geen verschil — alleen snellere responstijden.",
                },
                {
                    "vraag": "Wat als het niet levert?",
                    "antwoord": "Geen meetbare verbetering in 90 dagen? Dan terugbetaling van de eerste 3 maanden.",
                },
            ],
        },
    },
    ...
    "faq_generiek": [
        {
            "vraag": "Hoe werkt het?",
            "antwoord": "Je beschrijft je bedrijf, wij bouwen je AI-agent, jij scant een QR-code en bent binnen 2 minuten live.",
        },
        {
            "vraag": "Heb ik WhatsApp Business API nodig?",
            "antwoord": "Nee. Je kunt starten met een QR-code, geen API vereist.",
        },
        {
            "vraag": "Hoeveel integraties hebben jullie?",
            "antwoord": "40+ integraties, waaronder HubSpot, Salesforce, Google Sheets, Zapier, Calendly en Stripe.",
        },
        {
            "vraag": "Kan ik de gesprekken aanpassen?",
            "antwoord": "Ja. Je agent spreekt precies dezelfde taal als jij. Jij stelt de toon, wij bouwen hem in.",
        },
        {
            "vraag": "Is support inbegrepen?",
            "antwoord": "Ja. Elke klant heeft een vaste contactpersoon. Geen chatbots als support.",
        },
    ],
}
